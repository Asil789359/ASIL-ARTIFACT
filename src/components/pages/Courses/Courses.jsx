    ...
    <PageTemplate hasTransitionPanel={true}>
      <StyledCourses>
        ...
        <div className="intro" data-aos="fade" data-aos-duration="800">
          ...
          <p className="text-regular">
            Avec plus de 5 ans d'expérience dans ce domaine, mon parcours m'a conduit à la passion du partage de connaissances. C'est cet enthousiasme pour l'enseignement
