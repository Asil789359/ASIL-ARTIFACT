...
const contentsList = [
  {
    headline: "Article 1",
    title: "Objet",
    text: `Les présentes Conditions Générales de Vente (ci-après « CGV ») ont pour objet de définir les droits et obligations de Mohammed Asil (ci-après « le Prestataire ») et de ses clients (ci-après « les Clients ») dans le cadre de la vente de services de formation en ligne. La validation d'une commande de formation à travers le système de réservation intégré Cal.com implique l'acceptation entière et sans réserve des présentes CGV par le Client.`,
  },
  {
    headline: "Article 2",
  ...
  },
  {
    ...
    text: `Tout le matériel pédagogique fourni lors des formations, y compris mais sans s'y limiter, les documents, les présentations, les vidéos et les graphiques, est la propriété exclusive de Mohammed Asil. Toute utilisation non autorisée, reproduction, distribution ou vente sans l'accord écrit préalable du Prestataire constitue une violation des droits de propriété intellectuelle et est passible de poursuites judiciaires.`,
  },
  {
    headline: "Article 6",
    title: "Limitation de responsabilité",
    text: `Le Prestataire s'engage à fournir les services de formation avec professionnalisme et diligence. Cependant, la responsabilité de Mohammed Asil ne pourra être engagée en cas de préjudice indirect subi par le Client, y compris toute perte d'exploitation, perte de profit ou perte de chance. La responsabilité du Prestataire sera en tout état de cause limitée au montant des sommes effectivement versées par le Client au titre de la formation concernée.`,
  },
  {
    headline: "Article 7",
    title: "Modification des CGV",
    text: `Mohammed Asil se réserve le droit de modifier les présentes CGV à tout moment. Les nouvelles CGV seront, le cas échéant, notifiées au Client avant leur entrée en vigueur et applicables uniquement aux contrats conclus postérieurement à cette modification.`,
  },
  {
    headline: "Article 8",
    title: "Loi applicable et juridiction",
    text: `Les présentes CGV sont soumises au loi française. En cas de litige survenant entre le Prestataire et un Client, les parties s'engagent à rechercher en priorité une solution amiable. À défaut d'accord, le litige pourra être porté devant les tribunaux compétents selon les règles de droit commun.`,
  },
];
