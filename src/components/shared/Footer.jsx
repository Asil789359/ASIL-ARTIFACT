    ...
    <Container>
      <div className="home-section contact">
        ...
        <div className="footer-body">
          <motion.a href="tel:9842978385" className="text-h1">
            Call me
          </motion.a>
          <motion.div
          ...
          >
            <span className="text-h1">
              ...
              <span className="word">
                <span> email</span>
                <a href="tel:9842978385" className="post"> +9842978385</a>
              </span>
            </span>
          </motion.div>
        </div>
...
@2024
          <ul className="socials">
            ...
            <li>
              <a
                className="text-link"
                href="https://x.com/AsilRabide2674"
                target="_blank"
              >
                twitter
              </a>
            ...
            <li>
              <a
                className="text-link"
                href="https://www.instagram.com/mohamedasilasil/"
                target="_blank"
              >
                instagram
              </a>
